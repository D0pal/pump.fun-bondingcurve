...
export class PumpFunSDK {
  ...
  async getBondingCurvePercentage(
    mint: PublicKey, 
    commitment: Commitment = DEFAULT_COMMITMENT
  ) {
    ...
    if (bondingCurveAccount && globalAccount) {
      let initialvirutalSOL = globalAccount.initialVirtualSolReserves;

      let initialRealTokenReserves = globalAccount.initialRealTokenReserves;
  
      let leftTokens = bondingCurveAccount?.realTokenReserves! - initialvirutalSOL;
